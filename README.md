...
> `Trippl` is a placeholder name (logo/name TBD — see `docs/decisions.md` D11). A group-trip planning app — Partiful, but for trips. Web + iOS + Android from one Expo/React Native codebase.
